...
- Saves are asynchronous. An immediate force-kill before a write finishes may lose the last change — not yet specifically tested; repeated ordinary kill/restart on-device has been confirmed clean.
